...
import { printIsolatedDocument, generateVoucherHTML } from '../utils/printHelper';
        ...
        <div className="p-6 bg-slate-50 flex justify-center">
          ...
          >
            ...
            <div className="text-center border-b-2 border-slate-800 pb-2 mb-4">
              <img src="/logo-15-de-abril.jpg" alt="Logo 15 de Abril" className="w-12 h-12 object-contain mx-auto mb-1.5" />
